...
$resp = isset($_REQUEST['resp']) ? $_REQUEST['resp'] : '0' ;
if ($resp == '0'){
$ticket_query = mysql_query("SELECT * FROM sys_tickets where id_ticket = '".$id_ticket."'  ");
$ticket_fet = mysql_fetch_row($ticket_query);
}else{
  $ticket_query = mysql_query("SELECT * FROM sys_tickets_resp where id_ticket = '".$id_ticket."' order by id_tickets_resp desc ");
  $ticket_fet2 = mysql_fetch_row($ticket_query);
}
                ...
                <div class="ibox">
                  ...
                  <div class="ibox-content"> <!--inbox-->                 
                    ...
                    <div class="row"><!--inrow-->
                      ...
                      <form role="form" action="resp_ticket_exe.php" method="post">
                        ...
                        <input type="hidden"  name="id_usuario_crea" value="<?php echo $ticket_fet[2]; ?>">
                        ...
                        <div class="col-sm-12">
                          ...
                          <div class="panel panel-default">
                           ...
                           <div class="panel-heading"><h3 class="panel-title">Respuesta del Ticket</h3>
                                      ...
                                      <div class="col-md-12">
                                        ...
                                        <div class="control-group">
                                          ...
                                          <label label-default="" class="control-label">Detalle</label>
                                            ...
                                            <div class="controls">
                                              <?php if ($resp == '0'){ ?>
                                              <textarea name="detalle" style="margin: 0px; width: 100%; height: 100%" readonly><?php echo $ticket_fet[4]; ?></textarea>
                                              <?php } else { ?>
                                               
                                               <textarea name="detalle" style="margin: 0px; width: 100%; height: 100%" readonly><?php echo $ticket_fet2[3]; ?></textarea>
                                              <?php }  ?>
                                            </div>
